...
void analyzeSpectrum(TString dirname ="../Na22_20160629_tripla/", TString filename = "run_20160630_Na22_teflon_tripla", Int_t nChannels = 3) {
...
//            
            ...
            //Na22
            TH1F *hsum = new TH1F("hsum","; keV; entries",600,0,3000);
            TH1F *hRawEnergyCh0 = new TH1F("hRawEnergyCh0","; keV; entries",600,0,3000);
            TH1F *hRawEnergyCh1 = new TH1F("hRawEnergyCh1","; keV; entries",600,0,3000);
...
//                    hDeltat3g->Fill(dt3);
//                }
                if(en0 < 560 && en1 < 640  && en2 < 560 && en0>250 && en1 >250  && en2 >250 && TMath::Abs(dt01)<15 && TMath::Abs(dt02)<15) {

                    hsum->Fill(en0+en1+en2);
            ...
            c->cd(1);
            gPad->SetLogy();
            hRawEnergyCh0->Rebin(8);
            hRawEnergyCh1->Rebin(8);
            hRawEnergyCh2->Rebin(8);
            hsum->Rebin(8);
            hRawEnergyCh0->Draw();
